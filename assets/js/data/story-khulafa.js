...
{n:'Tetapi keadilan, baginya, bukan konsep di atas kertas — ia memeriksanya sendiri dengan kakinya. Di tahun paceklik, ia biasa berkeliling pinggiran Madinah pada malam hari bersama pelayannya, Aslam, memastikan tak ada satu perut pun yang terlewat.', s:'Riwayat sejarah', g:'sirah'},
{n:'Suatu malam ia melihat nyala api dari kejauhan. Seorang perempuan menjerang periuk di atas tungku, dikelilingi anak-anak yang menangis. Umar mendekat dan bertanya. Ternyata di dalam periuk hanya ada air dan batu — ia mengaduknya agar anak-anaknya mengira makanan sedang dimasak, sampai mereka lelah dan tertidur.'},
{n:'Perempuan itu — tak tahu kepada siapa ia sedang bicara — mengeluh lirih: “Biarlah Allah yang mengadili antara kami dan Umar. Bagaimana ia bisa tidur kenyang sementara kami kelaparan?”'},
{a:'Bayangkan menjadi penguasa, lalu mendengar rakyatmu mengadukanmu — kepada Tuhan, tepat di depanmu, tanpa tahu bahwa itu kau.'},
{n:'Umar bergegas kembali ke Baitul Mal dan memikul sendiri sekarung gandum serta sekantong lemak di punggungnya. Aslam menawarkan diri memanggulnya. Umar menolak.'},
{r:'Umar bin Khattab r.a.', x:'Apakah kau akan memikul dosaku untukku pada Hari Kiamat?', s:'Riwayat sejarah; derajatnya diperbincangkan', g:'sirah'},
{n:'Ia memasak sendiri untuk mereka, meniup api hingga asap menyelinap ke janggutnya, dan tidak beranjak sampai anak-anak itu makan kenyang lalu tertawa kembali. Baru setelah itu ia pulang.'},
