...
nodes:[
{vid:'um_6_00-02', n:'Umar menjadi khalifah kedua. Ia orang pertama yang dipanggil <em>Amirul Mukminin</em> — pemimpin orang-orang beriman.', s:'Riwayat sejarah', g:'sirah'},
{vid:'um_6_00-02', n:'Ia membangun negara: mendirikan diwan (daftar tunjangan rakyat), menetapkan penanggalan Hijriah, menata peradilan, dan memisahkan kas negara dari harta pribadi.', s:'Riwayat sejarah', g:'sirah'},
{vid:'um_6_00-02', n:'Pemerintahannya bukan sekadar menaklukkan, melainkan menata. Ia melembagakan ronda malam untuk keamanan, mengangkat dan menggaji para hakim seperti Syuraih dan Abu Musa al-Asy‘ari, menunjuk pengawas pasar (hisbah) yang memeriksa timbangan dan harga, mencatat rakyat dalam diwan untuk membagikan tunjangan, dan memanggil para gubernur agar diperiksa terbuka di musim haji.', s:'Riwayat sejarah', g:'sirah'},
{vid:'um_6_03', n:'Tetapi keadilan, baginya, bukan konsep di atas kertas — ia memeriksanya sendiri dengan kakinya. Di tahun paceklik, ia biasa berkeliling pinggiran Madinah pada malam hari bersama pelayannya, Aslam, memastikan tak ada satu perut pun yang terlewat.', s:'Riwayat sejarah', g:'sirah'},
{vid:'um_6_04', n:'Suatu malam ia melihat nyala api dari kejauhan. Seorang perempuan menjerang periuk di atas tungku, dikelilingi anak-anak yang menangis. Umar mendekat dan bertanya. Ternyata di dalam periuk hanya ada air dan batu — ia mengaduknya agar anak-anaknya mengira makanan sedang dimasak, sampai mereka lelah dan tertidur.'},
{vid:'um_6_05-06', n:'Perempuan itu — tak tahu kepada siapa ia sedang bicara — mengeluh lirih: “Biarlah Allah yang mengadili antara kami dan Umar. Bagaimana ia bisa tidur kenyang sementara kami kelaparan?”'},
{vid:'um_6_05-06', a:'Bayangkan menjadi penguasa, lalu mendengar rakyatmu mengadukanmu — kepada Tuhan, tepat di depanmu, tanpa tahu bahwa itu kau.'},
{vid:'um_6_07-08', n:'Umar bergegas kembali ke Baitul Mal dan memikul sendiri sekarung gandum serta sekantong lemak di punggungnya. Aslam menawarkan diri memanggulnya. Umar menolak.'},
{vid:'um_6_07-08', r:'Umar bin Khattab r.a.', x:'Apakah kau akan memikul dosaku untukku pada Hari Kiamat?', s:'Riwayat sejarah; derajatnya diperbincangkan', g:'sirah'},
{vid:'um_6_09', n:'Ia memasak sendiri untuk mereka, meniup api hingga asap menyelinap ke janggutnya, dan tidak beranjak sampai anak-anak itu makan kenyang lalu tertawa kembali. Baru setelah itu ia pulang.'},
{vid:'um_6_10-12', c:'Tanggung jawab yang dipikul sendiri, bukan didelegasikan', x:'Ia bisa saja menyuruh pelayannya membawa gandum itu. Ia justru memanggulnya sendiri — sebab beban itu, di matanya, adalah <em>dosanya</em> seandainya ada yang kelaparan di bawah kekuasaannya. Bukan urusan administrasi, melainkan pertanggungjawaban pribadi di hadapan Allah.<br><br>Inilah yang membuatnya berkata bahwa seekor keledai yang terperosok di jalan Irak pun bisa ditanyakan kepadanya.'},
{vid:'um_6_10-12', r:'Umar bin Khattab r.a.', x:'Seandainya seekor keledai terperosok di Irak, sungguh aku takut Allah akan menanyaiku: mengapa tidak kau ratakan jalan untuknya?', s:'Atsar', g:'sirah'},
{vid:'um_6_10-12', n:'Dan Irak yang ia sebut itu bukanlah negeri khayalan. Di bawah kepemimpinannya, wilayah Islam benar-benar membentang hingga ke sana dan jauh melampauinya — sehingga rasa tanggung jawabnya ikut merentang sampai ke jalan-jalan yang tak pernah ia injak sendiri.'},
{vid:'um_6_13-14', n:'Di masanya, kekuatan Persia dan Romawi di Syam runtuh. Ketika Baitul Maqdis menyerah, penduduknya meminta agar khalifah sendiri yang datang menerima kuncinya.'},
{vid:'um_6_13-14', n:'Umar datang nyaris tanpa pengawal, berbagi satu unta dengan pelayannya secara bergantian — dan ketika tiba, kebetulan giliran sang pelayan menunggang sementara Umar menuntun di depan. Jubahnya bertambal.', s:'Sirah — Ath-Thabari', g:'sirah'},
